...
namespace Toolbox
{
    ...
    public static class AStar
    {
        ...
        public static List<Vector3Int> FindPathClosest(Tilemap map, Vector3Int start, Vector3Int goal)
        {
            ...
            return AStar.FindPath(new FourDirectionGraph(map), start, goal, Heuristic.ManhattanDist);
        }
        ...
        {
            return FindPath(new FourDirectionGraph(map), start, goal, Heuristic.ManhattanDist);
        }
